...
export default {
  data: {
  "name": "radio",
  "description": "Play a radio (onlineradiobox's source)",
  "options": [
    {
      "type": 3,
      "name": "query",
  ...
  code: `
    ...
    $getRecord[global;checkfirstdb;cachesearch_global-radio_$md5[$toLowercase[$option[query]]$advancedTextSplit[$env[result2;0;1];/;1]0]]
    $if[$env[checkfirstdb]=={};
    ...
    ;
    $getRecord[global;loadstate;cachesearch_global-radio_$md5[$toLowercase[$option[query]]$advancedTextSplit[$env[result2;0;1];/;1]0]]
