module.exports = {
    ...
    $try[
        ...
        $if[$get[a3]!=;$setCache[authmusic_youtube_key;$get[a3]]]
    ...
    $try[
        ...
        $if[$get[granted_token]!=;$setCache[authmusic_spotify_token;$get[granted_token]]]
    ...
    $try[
        ...
        $if[$get[a30]!=;$setCache[authmusic_qobuz;$deflate[$get[a30];base64]]]
