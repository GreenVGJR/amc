module.exports = {
    ...
    $try[
        ...
        $httpAddHeader[Authorization;Bearer $get[xts_ot]]
        $httpAddHeader[User-Agent;$get[agent]]
        $httpAddHeader[Accept-Encoding;gzip, deflate, br]
        $httpSetContentType[Text]
    ...
    $if[$or[$get[xts_ot]==;$get[xts_qi]==;$get[xts_ry]==];$logger[Warn;Re-trying - Twitter] $callFunction[generateAuthKeys;twitter;;true]]
    ]
    $return
    `
}
