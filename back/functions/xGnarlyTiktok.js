// Credits:
// https://github.com/justscrapeme/tiktok-web-reverse-engineering/blob/main/encode.js
...
module.exports = {
    ...
    encode(
    {
        queryString: ctx.getEnvironmentKey("parameter"),
        body: "",
        userAgent: ctx.getEnvironmentKey("userAgent")
    }
    )
    ]]]
    $return[$get[a]]`
