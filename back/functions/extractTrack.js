module.exports = {
    ...
    $let[http;$httpRequest[https://www.youtube.com/youtubei/v1/player?prettyPrint=false&fields=videoDetails(videoId,title,lengthSeconds,channelId,isCrawlable,viewCount,author,isPrivate,isLiveContent);POST;reshttp]]
    ...
    $let[http;$httpRequest[https://api.spotify.com/v1/tracks/$advancedTextSplit[$env[filterid;id];/;1];GET;a]]
