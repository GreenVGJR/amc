module.exports = {
    ...
    $!httpRequest[https://api-boot.tiktokv.com/aweme/v1/music/aweme/?music_id=$env[filterid;id]&aid=1322&device_id=$randomNumber[100000000;999999999;false]$randomNumber[1000000000;9999999999;false]&user_is_login=true&cookie_enabled=true;GET;a]
    ...
    $httpAddHeader[User-Agent;$get[agent]]
    $httpAddHeader[Cookie;$inflate[$getCache[authmusic_tiktok];base64]]
    $let[xgnarly;$callFunction[xGnarlyTiktok;count=10&cursor=0&aid=1180&device_id=$getCache[authmusic_tiktok_did]&user_is_login=true&cookie_enabled=true&keyword=$encodeURI[$get[stctitle]];$get[agent]]]
    $!httpRequest[https://api-boot.tiktokv.com/aweme/v1/music/search/?count=10&cursor=0&aid=1180&device_id=$getCache[authmusic_tiktok_did]&user_is_login=true&cookie_enabled=true&keyword=$encodeURI[$get[stctitle]]&X-Gnarly=$get[xgnarly];GET;c]
    $onlyIf[$env[c]!=;$return]
    $jsonLoad[c;$env[c]]
    ...
    $httpSetBody[audio_cluster_id=$env[filterid;id]&original_sound_audio_asset_id=$env[filterid;id]]
    $httpAddHeader[Content-Type;application/x-www-form-urlencoded]
    $httpAddHeader[User-Agent;Instagram 1000.0.0 Android]
    $httpAddHeader[Origin;https://www.instagram.com]
    $httpAddHeader[Sec-Fetch-Site;none]
    $httpAddHeader[Accept;*/*]
    $httpRemoveHeader[Accept-Encoding]
    $!httpRequest[https://www.instagram.com/api/v1/clips/music/;POST]
    $let[results;{"status":null,"results":$if[$httpResult[items;0]==;null;$httpResult]}]
    ]
