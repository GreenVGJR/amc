module.exports = {
    ...
    $if[$or[$env[a;results;authorInfos]!=;$env[a;results;id_str]!=];
    ...
    ;
    $let[author;$env[a;results;authorInfos;uniqueId]]
    $let[title;$default[$env[a;results;itemInfos;text];$env[a;results;itemInfos;id]]]
    ]
    ;
