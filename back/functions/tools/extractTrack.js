module.exports = {
    ...
    $httpSetContentType[Text]
    $let[http;$httpRequest[https://www.tiktok.com/share/video/$env[filterid;id];GET]]
    ...
    $!djsEval[fetch(ctx.getKeyword("url"), { method: "HEAD", headers: { "Accept": "*/*" } }).then(a => ctx.setKeyword("url", a.url)).catch()]
