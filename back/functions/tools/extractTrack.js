module.exports = {
    ...
    $httpSetContentType[Text]
    $let[http;$httpRequest[https://m.tiktok.com/v/$env[filterid;id].html;GET]]
    ...
    $if[$isJSON[$env[a]]==false;$return[{"status":null,"results":{"error":"Content unavailable or Tiktok throw anti-bot challenges."}}]]
