...
$!httpRequest[https://www.last.fm/search/artists?q=$env[query]&_pjax=%23content;GET]
$let[checkauthor;$advancedTextSplit[$httpResult;"artist-results";1;href=";1;";0]]
$onlyIf[$get[checkauthor]!=;$return[null]]
$let[authorurl;https://www.last.fm$get[checkauthor]]
$httpAddHeader[Accept-Encoding;gzip]
$httpAddHeader[User-Agent;$get[agent]]
$httpSetContentType[Text]
...
$title[$advancedTextSplit[$httpResult;resource-name=";1;data-page;0;";0];$get[authorurl];0]
