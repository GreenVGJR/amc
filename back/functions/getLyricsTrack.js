module.exports = {
    ...
    $arrayLoad[results;]
    $arrayPushJSON[results;$trimLines[{"status_1":null,"status_2":null,"response_time":"$env[pullyt;ping]","results":{"provider":"youtube","thumbnail":"https://i.ytimg.com/vi/$advancedTextSplit[$if[$env[isExclude]!=true;$trackInfo[url];$env[pullyt;results;0;url]];?v=;1;&;0]/maxres2.jpg","query":"$encodeURI[$env[query]]","url":"$if[$env[isExclude]!=true;$trackInfo[url];$env[pullyt;results;0;url]]","autocomplete":"$encodeURI[$if[$env[isExclude]!=true;$env[query];$env[pullyt;results;0;title]]]","lyric":"$deflate[$get[ytmusic];hex]"}}]]
    ;
