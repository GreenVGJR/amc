...
$!putRecord[user;storejson;storeplaylist_user-$get[hash]_$authorID]
;
$let[hash;$md5[$authorID_$toLowercase[$trim[$input[doplaylistuser_title]]]]]
...
$jsonLoad[storeval;$env[storejson;value]]
$!putRecord[user;storeval;storeplaylist_user-$get[hash]_$authorID]
]
$if[$get[checkaction]!=create;
$interactionUpdate[
...
$getRecord[user;checkdbtempact;storetempl-act_ls_user-$get[hash]]
$let[checkdbtempact;$checkCondition[$env[checkdbtempact]!={}]]
...
$addButton[editplaylistuserh_$get[hash]$if[$env[checkdbtempact];_1_slu];Edit Tracks;Secondary;🎶]
...
$let[cotsr;]
$loop[10;$if[$env[listracks;$sub[$env[cotrsls];1]]==;$break]$let[cotsr;$get[cotsr]- $cropText[$default[$env[listracks;$sub[$env[cotrsls];1];title];$env[listracks;$sub[$env[cotrsls];1];url]];0;90;...]\n];cotrsls;true]
$jsonLoad[tmpsl;{"list":\\[$selectMenuValues[;,]\\]}]
$if[$and[$selectMenuValues[0]!=;$advancedTextSplit[$customID;_;3]==slu];$!putRecord[user;tmpsl;storetempl-act_ls_user-$advancedTextSplit[$customID;_;1]]]
...
$!putRecord[user;confplaylistdb;configplaylistuser_vgjra9f_$authorID]
$interactionUpdate[$callFunction[loadPlaylistUser;;;true]]
]
...
$jsonLoad[aval;$env[a;value]]
$!putRecord[user;aval;storeplaylist_user-$advancedTextSplit[$customID;_;2]_$authorID]
$interactionUpdate[
$footer[Done]
$color[$callFunction[useIcon;color_embed]]
$addActionRow
...
$getRecord[user;checktempdb;storetempl-act_ls_user-$advancedTextSplit[$customID;_;2]]
$jsonLoad[b;$env[checktempdb]]
...
$getRecord[user;lookmatch;storetempl-act_ls_user-$advancedTextSplit[$customID;_;2]]
$onlyIf[$env[lookmatch]!={};$ephemeral $callFunction[useCustomMusicMessage;config_generalPlaylistTempNotExistUser]]
$interactionUpdate[
...
$jsonLoad[ubval;$env[ub;value]]
$!putRecord[user;ubval;storeplaylist_user-$advancedTextSplit[$customID;_;1]_$authorID]
...
$let[checkdb;$callFunction[findPlaylistUser;$advancedTextSplit[$customID;_;1];$authorID]]
$onlyIf[$get[checkdb]!=;$ephemeral $callFunction[useCustomMusicMessage;config_generalPlaylistNotExistUser]]
$getRecord[user;lookmatch;storetempl-act_ls_user-$advancedTextSplit[$customID;_;1]]
$onlyIf[$env[lookmatch]!={};$ephemeral $callFunction[useCustomMusicMessage;config_generalPlaylistTempNotExistUser]]
$interactionUpdate[
$footer[Updating Tracks;$callFunction[useIcon;loading]]
$color[$callFunction[useIcon;color_embed]]
]
$jsonLoad[o;$env[lookmatch]]
...
$jsonLoad[otval;$env[ot;value]]
$!putRecord[user;otval;storeplaylist_user-$advancedTextSplit[$customID;_;1]_$authorID]
$!removeRecord[user;storetempl-act_ls_user-$advancedTextSplit[$customID;_;1]]
$interactionUpdate[
$footer[Done]
$color[$callFunction[useIcon;color_embed]]
