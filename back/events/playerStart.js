module.exports = [{
    ...
    $async[$callFunction[musicPlayerMessage;$get[cid];$get[mid];$env[track];$checkCondition[$sum[$get[elapsedtime];$get[nextmessage_time]]>=$env[track;durationMS]];intervalmusicmessage_$guildID_$get[cid];$guildID]];$get[interval_time];intervalmusicmessage_$guildID_$get[cid]]
    `
},
{ 
    type: "playerPause",
    ...
    $let[cid;$getVar[musicplayer_message;$guildID_channelid]]
    $let[mid;$getVar[musicplayer_message;$guildID_messageid]]
    $try[$!clearInterval[intervalmusicmessage_$guildID_$get[cid]]]
    `
},
{
    type: "playerResume",
    ...
    $let[calculatetime;$sum[$callFunction[musicVirtualDuration;$guildID;$get[cid]];$get[interval_time]]]
    $let[elapsedtime;$if[$hasMusicNode;$callFunction[musicVirtualDuration;$guildID;$get[cid];$get[calculatetime]];0]]
    $async[$callFunction[musicPlayerMessage;$get[cid];$get[mid];$env[testmessage;0];$checkCondition[$sum[$get[elapsedtime];$get[nextmessage_time]]>=$env[track;durationMS]];intervalmusicmessage_$guildID_$get[cid];$guildID]];$get[interval_time];intervalmusicmessage_$guildID_$get[cid]]
    `
},
{
    type: "playerFinish",
