import { default_userAgent_desktop, streamTypeYT, useClientYT, cacheTrackYT, skipOnCheckFormat, useNativeStream } from "../config.json";
...
import { initBotGuard, refreshBotGuardIntegrity, generateCbPot, generateSessionPoToken, generateAnonPOT, setVisitorData, invalidateBotGuard } from "./youtubeBG";
