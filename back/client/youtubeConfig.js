...
async function fallbackYTStream(lstracks) {
    ...
    try {
        ...
        let a = await request(`https://${hostdomain}/youtubei/v1/player?prettyPrint=false&fields=playabilityStatus,streamingData(hlsManifestUrl,adaptiveFormats(itag,url,contentLength)),videoDetails(isLiveContent)`, {
        ...
        if (a.videoDetails.isLiveContent || streamTypeYT === 2) {
            ...
            finalurl = fr.url + "&ratebypass=true&alr=no&range=0-" + fr.contentLength;
        }
