...
async function fallbackYTStream(lstracks) {
    ...
    if(!a.url) { throw new Error(); }
        return a.url + "&ratebypass=true&range=0-";
    }
    catch {
        throw new Error();
    }
