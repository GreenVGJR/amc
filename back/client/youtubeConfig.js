...
async function fallbackYTStream(lstracks) {
    ...
    let a = await request('https://www.youtube.com/youtubei/v1/player?prettyPrint=false&fields=streamingData(hlsManifestUrl,adaptiveFormats(itag,url,contentLength)),videoDetails(isLiveContent)', {method: "POST", body: JSON.stringify(pl), headers: {
