module.exports = {
    ...
    $if[$env[successlog]==true;$log[$if[$env[storeclientid;0]!=;OK - $cropText[$env[storeclientid;0];0;12;...];Failed to Retrieve] - Soundcloud / Player]]
    $if[$env[successlog]==true;$log[$if[$env[storeclientid;1]!=;OK - $cropText[$env[storeclientid;1];0;12;...];Failed to Retrieve] - Soundcloud / Stream]]
