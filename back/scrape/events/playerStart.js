...
;$queue[;23;{track.title};
    ...
    $addField[Duration;$if[$env[jsonmusicdata;durationMS]==0;$parseDigital[$get[elapsedtime]] - LIVE;$parseDigital[$get[elapsedtime]] - $parseDigital[$env[jsonmusicdata;durationMS]]];true;1]
    ...
    $addField[Duration;$if[$env[jsonmusicdata;durationMS]==0;$parseDigital[$get[elapsedtime]] - LIVE;$parseDigital[$get[elapsedtime]] - $parseDigital[$env[jsonmusicdata;durationMS]]];true;0]
    ...
    $addOption[$cropText[$env[yesnt];0;97;...];;$get[countqueue]]
    $letSum[countqueue;1]
    ]
    ;
