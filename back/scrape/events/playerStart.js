...
;$queue[;23;{track.title};
    ...
    $addActionRow
    $addStringSelectMenu[musicplayer_nodequeue_$env[messageId]_$randomBytes[4];$cropText[Queue | $djsEval[require("entities").decodeHTML("$replace[$trackInfo[title];";\\\\"]")];0;61;...];$or[$queueLength==0;$getLoopMode==TRACK];1;1]
