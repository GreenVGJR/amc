module.exports = {
    ...
    $arrayLoad[results;]
    $arrayPushJSON[results;$trimLines[{"status_1":$get[http],"status_2":$get[http2],"response_time":"$sub[$getTimestamp;$get[time]]","results":{"provider":"azlyrics","query":"$encodeURI[$env[query]]","url":"$get[a]","autocomplete":"$replace[$replace[$get[b];\\\\;];";\\\\"]","lyric":"$deflate[$get[a1];hex]"}}]]
    ]
    ]
    ]
